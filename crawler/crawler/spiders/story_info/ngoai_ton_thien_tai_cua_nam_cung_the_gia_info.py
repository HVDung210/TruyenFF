...
class NgoaiTonThienTaiCuaNamCungTheGiaInfoSpider(scrapy.Spider):
    name = "ngoai_ton_thien_tai_cua_nam_cung_the_gia_info"
    allowed_domains = ["truyenqqgo.com"]
    start_urls = ["https://truyenqqgo.com/truyen-tranh/ngoai-ton-thien-tai-cua-nam-cung-the-gia-16187"]
